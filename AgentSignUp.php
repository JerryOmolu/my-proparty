<?php
$pageTitle = "Agent Signup - My Proparty";
?>
<?php ob_start(); ?>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center pb-4">
      <div class="col-md-8 text-center">
        <h2 class="text-success mb-3">Agent Sign Up Form</h2>
        <div class="alert alert-info text-start">
          <b>This is for those who want to take their involvement with My Proparty to the next level. </b>
          <p class="mb-1">Small Business Owners, Office Managers, and Cyber Cafe Owners can apply as Agents of My Proparty. Agents are like supervisors, overseeing a group of operators (Up to 20 operators) and ensuring all operations run smoothly. They can earn even more money and have a larger impact on their community, providing a vital service that truly makes a difference. </p>
...
<body>
  <div class='container'>
    ...
    <div class='body'>
      ...
      <p>You have successfully signed up with <b>My Proparty</b> as an Agent.</p>
...
";
  ...
  <strong>Thank You!</strong> Registration as Agent is Successful!
</div>";
		}
