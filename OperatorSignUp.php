<?php
$pageTitle = "Operator Signup - My Proparty";
?>
<?php ob_start(); ?>
...
<div class="page-title dark-background" style="background-image: url(assets/img/app-img/DV1.jpg);">
  <div class="container position-relative">
    ...
    <p style="text-align: center;">Independent Operator</p>
  </div>
</div><!-- End Page Title -->
  ...
  <div class="container">
    ...
    <div class="row justify-content-center pb-4">
      <div class="col-md-8 text-center">
        <h2 class="text-success mb-3">Independent Operator Sign-Up</h2>
        <div class="alert alert-info text-start">
          <b>This option is for individuals who want to add to their business and earn extra cash.</b>
          <p class="mb-1">POS agents, Cyber Café operators can apply as 'My Proparty Independent Operator'.</p>
          <p class="mb-1">You'll receive all necessary information and free training to get started.</p>
...
<body>
  <div class='container'>
    ...
    <div class='body'>
      ...
      <p>You have successfully signed up with <b>My Proparty</b> as an Independent Operator.</p>
...
";
    ...
    if(isset($_POST['operator_signup'])){
        ...
        $e = "SELECT email FROM operator_signup	WHERE email = '$email' LIMIT 1";
		...
		$p = "SELECT phone FROM operator_signup WHERE phone = '$phone' LIMIT 1";
	...
	$query = "INSERT INTO operator_signup (title,fullname,gender,date_of_birth,phone,email,state,lga,state_of_interest,area,city,address,signup_date,verify_token)VALUES('{$title}','{$fullname}','{$gender}','{$date_of_birth}','{$phone}','{$email}','{$state}','{$lga}','{$state_of_interest}','{$area}','{$city}','{$address}',now(),'{$verify_token}')";
  ...
  <strong>Thank You!</strong> Registration as Independent Operator is Successful!
</div>";
            }
  ...
  <div class="col-md-4 form-group">
    ...
    <hr>
     <div class="col-md-6 form-group">
        <button type='submit'  name='operator_signup' class='btn btn-block btn-primary'>
                      Submit
         </button></div>
</form>
          </div>
